...
const raidBosses: { [key: string]: RaidId } = {
  ...
  Lucifron: RaidId.ZUL_GURUB,
  Magmadar: RaidId.ZUL_GURUB,
  Gehennas: RaidId.ZUL_GURUB,
  Garr: RaidId.ZUL_GURUB,
  "Baron Geddon": RaidId.ZUL_GURUB,
  Shazzrah: RaidId.ZUL_GURUB,
  "Sulfuron Harbinger": RaidId.ZUL_GURUB,
  "Golemagg the Incinerator": RaidId.ZUL_GURUB,
  "Majordomo Executus": RaidId.ZUL_GURUB,
  Ragnaros: RaidId.ZUL_GURUB,
